...
pub fn default_causal_cue_frames() -> Vec<CausalCueFrame> {
    ...
    use CausalCueRole::{Blocked, Blocker, Cause, Condition, Effect, Explanation, Goal, Motivation};

    vec![
        cue_frame("because", CausalKind::Causes, RightToLeft, Effect, Cause, 1000),
        cue_frame("because of", CausalKind::Causes, RightToLeft, Effect, Cause, 1005),
        cue_frame("due to", CausalKind::Causes, RightToLeft, Effect, Cause, 990),
        cue_frame("owing to", CausalKind::Explains, RightToLeft, Effect, Explanation, 920),
        cue_frame("caused by", CausalKind::Causes, RightToLeft, Effect, Cause, 1000),
        cue_frame("led to", CausalKind::ResultsIn, LeftToRight, Cause, Effect, 960),
        cue_frame("resulted in", CausalKind::ResultsIn, LeftToRight, Cause, Effect, 960),
        cue_frame("triggered", CausalKind::TriggerFor, LeftToRight, Cause, Effect, 950),
        cue_frame("enabled", CausalKind::Enables, LeftToRight, Cause, Effect, 940),
        cue_frame("allowed", CausalKind::Enables, LeftToRight, Cause, Effect, 930),
        cue_frame("prevented", CausalKind::Prevents, LeftToRight, Blocker, Blocked, 970),
        cue_frame("blocked", CausalKind::Prevents, LeftToRight, Blocker, Blocked, 965),
        cue_frame("in order to", CausalKind::PurposeOf, LeftToRight, Motivation, Goal, 930),
        cue_frame("so that", CausalKind::PurposeOf, LeftToRight, Motivation, Goal, 900),
        cue_frame("so as to", CausalKind::PurposeOf, LeftToRight, Motivation, Goal, 900),
        cue_frame("wanted to", CausalKind::Motivates, LeftToRight, Motivation, Goal, 880),
        cue_frame("therefore", CausalKind::Explains, LeftToRight, Cause, Effect, 860),
        cue_frame("thus", CausalKind::Explains, LeftToRight, Cause, Effect, 850),
        cue_frame("hence", CausalKind::Explains, LeftToRight, Cause, Effect, 850),
        cue_frame("as a result", CausalKind::ResultsIn, LeftToRight, Cause, Effect, 900),
        cue_frame("consequently", CausalKind::ResultsIn, LeftToRight, Cause, Effect, 890),
        CausalCueFrame {
